  ...
  <div class="register">
    <div v-show="choiceShow">
      ...
      <div class="confirm-btn" @click="toRevise">
        <div class="btn-zc" :style="{backgroundColor:(disabledSubmit?'#FA5300':'#999')}">注册</div>
      </div>
...
export default {
  ...
  methods: {
    ...
    userregister() {
      ...
      this.formData.companyAreaIds = arr.toString();
